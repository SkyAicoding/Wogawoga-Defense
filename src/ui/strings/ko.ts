...
export const ko: Record<string, string> = {
  ...
  'battle.gate.rally': '집결',
  // ⚠ 뜻이 '붙잡으러 보낸다'가 아니라 **'멀리 나간 일꾼을 되부른다'**이다:
  //   집결점과 문간선이 기하로 겹쳐 있어 마을 앞의 부족원은 이미 붙잡고 있다.
  'battle.gate.rallyHint': '부족원 전원을 마을로 — 캐러 나간 일꾼까지 되부릅니다',
  // 띠 제목. "문간"이 이 기능 전체의 이름이다
  'battle.gate.title': '문간',
  // 문 앞의 빚 합계 = 저것들을 하나도 못 죽였을 때 마을이 잃을 HP (한 입 = 1이라 초 수이기도 하다)
  'battle.gate.owed': '문 앞 −{n}',
  /*
