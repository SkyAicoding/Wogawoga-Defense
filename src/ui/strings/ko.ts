...
export const ko: Record<string, string> = {
  ...
  'ally.clubber.desc': '싸고 발 빠른 근접. 붙으면 적의 발을 묶는다',
  'ally.slinger.name': '돌팔매꾼',
  'ally.slinger.desc': '뒤에서 던진다. 공중도 맞힌다 (아무도 막지 못함)',
  'ally.guardian.name': '파수꾼',
  'ally.guardian.desc': '방패로 오래 버틴다. 한 놈을 길게 세워 둔다',
  ...
  'enemy.blade.name': '부족 칼잡이',
  'enemy.blade.desc': '무리지어 달려들어 돌칼로 타워를 두들겨 부숴요!',
  'enemy.lancer.name': '부족 창잡이',
  'enemy.lancer.desc': '한 걸음 뒤에서 창으로 찔러요. 방패와 가죽갑옷으로 단단해요.',
  'enemy.archer.name': '부족 궁수',
  'enemy.archer.desc': '멈추지 않고 걸으면서 멀리서 타워를 쏘아 갉아요. 몸은 약해요.',
  'enemy.hexer.name': '부족 주술 저주사',
  'enemy.hexer.desc': '저주를 걸어 타워를 잠시 침묵시켜요. 저주에 걸린 타워는 쏘지 못해요!',
