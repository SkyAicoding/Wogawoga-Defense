...
export const en: Record<string, string> = {
  ...
  'trait.shield.desc': 'Ignores the first few hits and refills over time — hit it often',
  ...
  'trait.purge.name': 'Cleanse',
  'trait.purge.desc': 'Strips slow, burn and poison from nearby allies — take this one first',
