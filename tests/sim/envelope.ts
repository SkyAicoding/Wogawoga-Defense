 ...
 * 독립 4블록으로 흩으면 같은 문턱에서 ⟦원장 11b.blocked = 1.6959⟧ — **문턱을 한 자리도
 ...
 *
 *   [6]  불도저     ⟦원장 6.dozer.notDominant = MDE 5판/80⟧
 *   [7]  유닛       ⟦원장 7.unit.notDominant = MDE 15판/80⟧
 *   [7]  기지600    ⟦원장 7.base600.notDominant = MDE 22판/80⟧
 *   [7]  기지자연   ⟦원장 7.baseNat.notDominant = MDE 3판/80⟧
 *   [10] 부족       ⟦원장 10.tribe.notDominant = MDE 8판/80⟧
 *   [13] 무한 부족  ⟦원장 13.tribe.notAhead = MDE 12판/24⟧
 *
 * 이 표가 말하는 것 셋:
 ...
 *   ⟦원장 cal.slope = 완주율 78.75% → 92.50%⟧ · ⟦원장 cal.slope = 여유 21.90% → 47.85%⟧.
