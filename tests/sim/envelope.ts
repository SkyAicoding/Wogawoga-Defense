 ...
 * 독립 4블록으로 흩으면 같은 문턱에서 ⟦원장 11b.blocked = 2.5656⟧ — **문턱을 한 자리도
 ...
 *   [7]  유닛       ⟦원장 7.unit.notDominant = MDE 15판/80⟧
 *   [7]  기지600    ⟦원장 7.base600.notDominant = MDE 21판/80⟧
 *   [7]  기지자연   ⟦원장 7.baseNat.notDominant = MDE 2판/80⟧
 *   [10] 부족       ⟦원장 10.tribe.notDominant = MDE 7판/80⟧
 *   [13] 무한 부족  ⟦원장 13.tribe.notAhead = MDE 14판/24⟧
 *
 * 이 표가 말하는 것 셋:
 ...
 *   ⟦원장 cal.slope = 완주율 80.00% → 93.75%⟧ · ⟦원장 cal.slope = 여유 21.40% → 48.85%⟧.
