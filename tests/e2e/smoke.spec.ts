 ...
 *
 * 실측 — **타워 인스턴싱 뒤**(desktop 1280×800 · swiftshader):
 *   s1 43콜 / 129,777   s2 41 / 120,942   s3 43 / 136,340
 *   s4 42 / 132,368     s5 43 / 131,597   s6 41 / 131,015
 * 그 전(타워가 개별 Mesh 이던 시절, 같은 레시피 · 3회 반복 중 최댓값):
 *   s1 76콜 / 131,483   s2 73 / 122,971   s3 76 / 137,991
 *   s4 75 / 134,380     s5 75 / 135,887   s6 73 / 134,069
 * **여섯 판 전부 콜이 32~33 줄었다**(타워 12기 × 3콜 − 묶음 넷). 삼각형은 그대로다 —
 * 묶기는 정점을 늘리지도 줄이지도 않는다. 최악 s3이 삼각형 예산의 90.9%.
 * 한 판이 약 13초라 6판 + 로딩까지 **1.3분**이다
